...
class Holds(val sv: SVar, val value: Var, val persists: TemporalInterval, val precedingChange: Boolean, val ref: Any /* TODO: LogStatement */)
  extends CausalStruct {
//  assert(ref.needsSupport) TODO
