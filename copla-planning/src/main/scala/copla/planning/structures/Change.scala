...
class Change(val sv: SVar, val value: Var, val changing: TemporalInterval, val persists: TemporalInterval, val ref: Any /* TODO: LogStatement */)
  extends CausalStruct {
//  assert(ref.isChange) TODO
