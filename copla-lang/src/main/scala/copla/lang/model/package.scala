...
package object model {
  ...
  object core {
    type InCore           = full.InCore
    type Var              = full.Var
    type TPRef            = full.TPRef
    type ConstantTemplate = full.ConstantTemplate
    type FluentTemplate   = full.FluentTemplate
    ...
    sealed trait StaticAssertion
        extends full.StaticAssertion[Var]
        with InModuleBlock
        with InActionBlock
